  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <div className="mt-4 border rounded p-4">
        <div className="text-sm text-gray-600">Booking ID: <span className="font-mono">{booking.id}</span></div>
        ...
        <div className="mt-4">
          <Link href="/my-bookings"><a className="text-pink-600">View all bookings</a></Link>
        </div>
      </div>
    </div>
  );
